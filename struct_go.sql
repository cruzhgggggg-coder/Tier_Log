...
CREATE TABLE `lecturers` (
  ...
  KEY `idx_lecturers_deleted_at` (`deleted_at`),
...
CREATE TABLE `consultation_logs` (
  ...
  `deleted_at` datetime(3) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_consultation_logs_deleted_at` (`deleted_at`),
  CONSTRAINT `fk_consultation_logs_student` FOREIGN KEY (`student_id`) REFERENCES `students` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `feedback_items` (
  ...
  `deleted_at` datetime(3) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_feedback_items_deleted_at` (`deleted_at`),
  CONSTRAINT `fk_feedback_items_log` FOREIGN KEY (`log_id`) REFERENCES `consultation_logs` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `lecturers` (`id`, `user_id`, `nip`, `name`, `faculty`, `created_at`, `updated_at`) VALUES
(1, 1, '198001012005011001', 'Dr. Arsitek Go, M.Kom', 'Informatika', NOW(), NOW());

INSERT INTO `students` (`id`, `user_id`, `lecturer_id`, `nim`, `name`, `prodi`, `thesis_title`, `created_at`, `updated_at`) VALUES
(1, 2, 1, '2200010001', 'Budi Mahasiswa', 'Teknik Informatika', 'Implementasi Microservices pada Sistem Log Bimbingan', NOW(), NOW());
